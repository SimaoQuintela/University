...
_lr_productions = [
  ...
  ('Corpo -> Corpo Proc Newline','Corpo',3,'p_Corpo','yacc.py',21),
  ('Corpo -> Newline','Corpo',1,'p_Corpo','yacc.py',22),
  ('Empty -> <empty>','Empty',0,'p_Empty','yacc.py',27),
  ('Newline -> NEWLINE','Newline',1,'p_Newline','yacc.py',32),
  ('Newline -> Empty','Newline',1,'p_Newline','yacc.py',33),
  ('Dedent -> Dedent DEDENT','Dedent',2,'p_Dedent','yacc.py',39),
  ('Dedent -> Empty','Dedent',1,'p_Dedent','yacc.py',40),
  ('Decls -> Decl Newline','Decls',2,'p_Decls','yacc.py',45),
  ('Decls -> Decls Decl Newline','Decls',3,'p_Decls','yacc.py',46),
  ('Decl -> INTDec ID','Decl',2,'p_Decl_Int','yacc.py',50),
  ('Decl -> INTDec ID ATRIB NUM','Decl',4,'p_Decl_Int_Val','yacc.py',61),
  ('Decl -> INTDec ID ATRIB Input','Decl',4,'p_Decl_Int_Input','yacc.py',72),
  ('Decl -> INTDec ID LSQBRACKET NUM RSQBRACKET ATRIB ArrayValues','Decl',7,'p_Decl_Int_Array_Val','yacc.py',83),
  ('Decl -> INTDec ID LSQBRACKET NUM RSQBRACKET','Decl',5,'p_Decl_Int_Array','yacc.py',93),
  ('Decl -> Def','Decl',1,'p_DEF','yacc.py',105),
  ('Def -> DEF ID COLON Newline INDENT Corpo DEDENT','Def',7,'p_Def','yacc.py',110),
  ('Def -> DEF ID COLON Newline INDENT Decls Corpo DEDENT','Def',8,'p_Def','yacc.py',111),
  ('ArrayValues -> LCURLBRACKET ArrayIntValues RCURLBRACKET','ArrayValues',3,'p_ArrayValues','yacc.py',119),
  ('ArrayIntValues -> ArrayIntValues , Expr','ArrayIntValues',3,'p_ArrayIntValues_Rec','yacc.py',123),
  ('ArrayIntValues -> Expr','ArrayIntValues',1,'p_ArrayIntValues','yacc.py',128),
  ('Proc -> Atrib','Proc',1,'p_Proc','yacc.py',134),
  ('Proc -> Print','Proc',1,'p_Proc','yacc.py',135),
  ('Proc -> If','Proc',1,'p_Proc','yacc.py',136),
  ('Proc -> Cycle','Proc',1,'p_Proc','yacc.py',137),
  ('Proc -> Call','Proc',1,'p_Proc','yacc.py',138),
  ('Proc -> Assert','Proc',1,'p_Proc','yacc.py',139),
  ('Call -> CALL','Call',1,'p_Call','yacc.py',144),
  ('Assert -> ASSERT LCPARENT Cond RCPARENT','Assert',4,'p_Assert','yacc.py',149),
  ('If -> IF LCPARENT Cond RCPARENT COLON Newline INDENT Corpo Dedent','If',9,'p_If','yacc.py',156),
  ('If -> IF LCPARENT Cond RCPARENT COLON Newline INDENT Corpo Dedent ELSE COLON Newline INDENT Corpo DEDENT','If',15,'p_If_Else','yacc.py',161),
  ('Cycle -> While','Cycle',1,'p_Cycle','yacc.py',167),
  ('Cycle -> DoWhile','Cycle',1,'p_Cycle','yacc.py',168),
  ('DoWhile -> DO COLON Newline INDENT Corpo Dedent WHILE LCPARENT Cond RCPARENT NEWLINE','DoWhile',11,'p_Do_While','yacc.py',172),
  ('While -> WHILE LCPARENT Cond RCPARENT COLON Newline INDENT Corpo Dedent','While',9,'p_While','yacc.py',177),
  ('Cond -> Expr GT Expr','Cond',3,'p_Cond','yacc.py',194),
  ('Cond -> Expr LT Expr','Cond',3,'p_Cond','yacc.py',195),
  ('Cond -> Expr GEQ Expr','Cond',3,'p_Cond','yacc.py',196),
  ('Cond -> Expr LEQ Expr','Cond',3,'p_Cond','yacc.py',197),
  ('Cond -> Expr EQUIV Expr','Cond',3,'p_Cond','yacc.py',198),
  ('Cond -> Expr NEQ Expr','Cond',3,'p_Cond','yacc.py',199),
  ('Cond -> Expr OR Expr','Cond',3,'p_Cond','yacc.py',200),
  ('Cond -> Expr AND Expr','Cond',3,'p_Cond','yacc.py',201),
  ('Cond -> NOT Cond','Cond',2,'p_Cond_NOT','yacc.py',205),
  ('Atrib -> ID ATRIB Expr','Atrib',3,'p_Atrib_Expr','yacc.py',210),
  ('Atrib -> ID ATRIB Input','Atrib',3,'p_Atrib_Input','yacc.py',218),
  ('Atrib -> ID INC','Atrib',2,'p_Atrib_INC_DEC','yacc.py',226),
  ('Atrib -> ID DEC','Atrib',2,'p_Atrib_INC_DEC','yacc.py',227),
  ('Atrib -> ID LSQBRACKET Expr RSQBRACKET ATRIB Expr','Atrib',6,'p_Atrib_Array','yacc.py',233),
  ('Print -> NonFormatted','Print',1,'p_Print_NonFormatted','yacc.py',246),
  ('NonFormatted -> PRINT LCPARENT Argument RCPARENT','NonFormatted',4,'p_NonFormatted','yacc.py',250),
  ('Argument -> String','Argument',1,'p_Argument_String','yacc.py',254),
  ('Argument -> Expr','Argument',1,'p_Argument_Expr','yacc.py',258),
  ('Expr -> Var','Expr',1,'p_Expr_Var_Inc','yacc.py',263),
  ('Expr -> ExprIncDec','Expr',1,'p_Expr_Var_Inc','yacc.py',264),
  ('Expr -> NUM','Expr',1,'p_Expr_Num','yacc.py',268),
  ('Expr -> Expr SUM Expr','Expr',3,'p_Expr_Arith','yacc.py',279),
  ('Expr -> Expr SUB Expr','Expr',3,'p_Expr_Arith','yacc.py',280),
  ('Expr -> Expr MULT Expr','Expr',3,'p_Expr_Arith','yacc.py',281),
  ('Expr -> Expr DIV Expr','Expr',3,'p_Expr_Arith','yacc.py',282),
  ('Expr -> Expr MOD Expr','Expr',3,'p_Expr_Arith','yacc.py',283),
  ('ExprIncDec -> ID INC','ExprIncDec',2,'p_Expr_Inc_Dec','yacc.py',287),
  ('ExprIncDec -> ID DEC','ExprIncDec',2,'p_Expr_Inc_Dec','yacc.py',288),
  ('Var -> ID','Var',1,'p_Var','yacc.py',295),
  ('Var -> ID LSQBRACKET Expr RSQBRACKET','Var',4,'p_Var_Array','yacc.py',307),
  ('Input -> INPUT LCPARENT String RCPARENT','Input',4,'p_Input','yacc.py',320),
  ('String -> QUOTE STRING QUOTE','String',3,'p_String','yacc.py',325),
  ('String -> Empty','String',1,'p_String_Empty','yacc.py',329),
]
